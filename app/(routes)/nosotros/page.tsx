...
function page() {
  ...
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:py-10 py-10 gap-5 sm:gap-10">
        <div className="w-full sm:h-96 flex flex-col gap-5 justify-center px-5 sm:px-20">
            ...
            <p className="font-medium sm:text-center">Somos una empresa que no solo representa una marca si no un estilo de vida saludable, en Eufrosine, garantizamos agua de mesa embotellada con los más altos estándares de calidad y pureza, cumpliendo con las exigencias del mercado peruano. Nuestra agua es más que una bebida: es salud, bienestar y un recurso esencial para la vida. Purificada con tecnología avanzada: ultrafiltración, ósmosis inversa, esterilización ultravioleta y ozonización, asegurando frescura y confianza en cada gota.</p>
        </div>
