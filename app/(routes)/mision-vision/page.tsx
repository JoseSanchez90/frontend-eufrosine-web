    ...
    <section className="w-full py-10 sm:py-20">
      <div className="px-2 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          <CardContainer>
            <CardBody className="bg-card-1 relative w-[350px] h-[260px] sm:w-[600px] sm:h-[300px] rounded-xl p-6 border-none flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-10">
              <CardItem translateZ="50" className="text-xl sm:text-3xl font-bold text-white">
                Visión
              </CardItem>
              <CardItem as="p" translateZ="60" className="text-white text-sm sm:text-md max-w-sm mt-2 ">
          ...
          <CardContainer>
            <CardBody className="bg-card-2 relative w-[350px] h-[260px] sm:w-[600px] sm:h-[300px] rounded-xl p-6 border-none flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-10">
              <CardItem translateZ="50" className="text-xl sm:text-3xl font-bold text-white">
                Misión
              </CardItem>
              <CardItem as="p" translateZ="60" className="text-white text-md max-w-sm mt-2">
