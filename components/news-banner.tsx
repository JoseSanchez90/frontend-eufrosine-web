...
const CarouselBanner = [
    {
        ...
        description: "Un equipo de investigadores de la Universidad Monash en Australia ha dado un paso significativo hacia una solución eficaz. Desarrollaron un material que puede purificar agua de mar en solo media hora. Estos hallazgos se publicaron en la revista Nature Sustainability.",
    ...
    },
    {
        ...
        description: "El telescopio espacial James Webb protagonizó otro gran hallazgo. Encontró rastros de agua en la atmósfera de un exoplaneta gigante llamado WASP-18b, que está ubicado a 400 años luz de la Tierra. Según las estimaciones de los científicos, su masa sería 10 veces mayor que la de Júpiter.",
    ...
    },
    {
        ...
        name: "Innovador sistema de riego reduce el consumo de agua en la agricultura en el mundo",
    ...
    },
    {
        ...
        description: "El cambio climático está acelerando tanto la escasez de agua como los peligros relacionados con este recurso (como inundaciones y sequías), ya que el aumento de las temperaturas altera los patrones de precipitación y todo el ciclo del agua. (UNICEF).",
    ...
    },
    {
        ...
        description: "Este hallazgo, que significa un aporte trascendental a la ciencia, fue realizado por especialistas del Instituto de Investigaciones de la Amazonía Peruana (IIAP), entidad técnica del Ministerio del Ambiente (Minam), tras un año y medio de estudios en campo y en laboratorio.",
